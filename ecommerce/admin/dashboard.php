<?php
    ...
    if (isset($_SESSION['Username'])) {
        ...
        $numUsers = 6; // Number of Latest Members

        $latestUsers = getLatest("*","admin","UserId",$numUsers); // Latest Users Array
          ...
          <div class="container text-center">
            ...
            <div class="col-md-3">
              <div class="stat st-members">
                ...
                <div class="info">
                  Total Members
                  <span><a href="members.php"><?php echo countItems('UserID','admin') ?></a></span>
                </div>
              </div>
            </div>
            <div class="col-md-3">
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    if(!empty($latestUsers)){
                      ...
                      echo'There\'s NO Recored TO Show';
                    }
